	...
	ul.appendChild(form);
	  ...
	  $("#save_all").click(function(){
		   ...
		   for(var i = 1 ; i<=len ;  i++){
			  ...
			  id = "sun-ul-room"+i ;
			  period[i-1].room_no = document.getElementById(id).value ;
			  id = "sun-ul-start-time"+i ;
			  var temp ;
			  temp = document.getElementById(id).value ;
			  temp += " to " ;
			  id = "sun-ul-end-time"+i;
			  temp += document.getElementById(id).value;
			  period[i-1].time = temp  ;
		   }
		   day[1].period = period ;
		   ...
		   for(var i = 1 ; i<=len ;  i++){
			  ...
			  id = "mon-ul-room"+i ;
			  period[i-1].room_no = document.getElementById(id).value ;
			  id = "mon-ul-start-time"+i ;
			  var temp ;
			  temp = document.getElementById(id).value ;
			  temp += " to " ;
			  id = "mon-ul-end-time"+i;
			  temp += document.getElementById(id).value;
			  period[i-1].time = temp  ;
		   }
		   day[2].period = period ;
		   ...
		   for(var i = 1 ; i<=len ;  i++){
			  ...
			  id = "tue-ul-room"+i ;
			  period[i-1].room_no = document.getElementById(id).value ;
			  id = "tue-ul-start-time"+i ;
			  var temp ;
			  temp = document.getElementById(id).value ;
			  temp += " to " ;
			  id = "tue-ul-end-time"+i;
			  temp += document.getElementById(id).value;
			  period[i-1].time = temp  ;
		   }
		   day[3].period = period ;
		   ...
		   for(var i = 1 ; i<=len ;  i++){
			  ...
			  id = "wed-ul-room"+i ;
			  period[i-1].room_no = document.getElementById(id).value ;
			  id = "wed-ul-start-time"+i ;
			  var temp ;
			  temp = document.getElementById(id).value ;
			  temp += " to " ;
			  id = "wed-ul-end-time"+i;
			  temp += document.getElementById(id).value;
			  period[i-1].time = temp  ;
		   }
		   day[4].period = period ;
